...
![](https://raw.github.com/apal7/java-design-patterns/master/images/images-observer-pattern/observer.png)
...
![](https://raw.github.com/apal7/java-design-patterns/master/images/images-observer-pattern/observer-comic-1.png)
...
![](https://raw.github.com/apal7/java-design-patterns/master/images/images-observer-pattern/solution1-en.png)
...
That’s why it’s crucial that all subscribers implement the same interface and that the publisher communicate with them only via that interface. This interface should declare the notification method along with a set of parameters that the publisher can use to pass some contextual data along with the notification.

![](https://raw.github.com/apal7/java-design-patterns/master/images/images-observer-pattern/solution2-en.png)
> Publisher notifies subscribers by calling the specific notification method on their objects.




If your app has several different types of publishers and you want to make your subscribers compatible with all of them, you can go even further and make all publishers follow the same interface. This interface would only need to describe a couple of the subscription methods. The interface would allow subscribers to observe publishers’ states without coupling to their concrete classes.



## Real-World Analogy
![](https://raw.github.com/apal7/java-design-patterns/master/images/images-observer-pattern/observer-comic-2.png)
...
## Structure
![](https://raw.github.com/apal7/java-design-patterns/master/images/images-observer-pattern/structure.png)
...
![](https://raw.github.com/apal7/java-design-patterns/master/images/images-observer-pattern/example.png)
