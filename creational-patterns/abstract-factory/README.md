...
![](https://raw.github.com/apal7/java-design-patterns/master/images/images-abstract-factory-pattern/abstract-factory.png)
...
2. Several variants of this family. For example, products Chair + Sofa + CoffeeTable are available in these variants: IKEA, VictorianStyle, ArtDeco.

![](https://raw.github.com/apal7/java-design-patterns/master/images/images-abstract-factory-pattern/problem-en.png)
> _Product families and their variants._


You need a way to create individual furniture objects so that they match other objects of the same family. Customers get quite mad when they receive non-matching furniture.

![](https://raw.github.com/apal7/java-design-patterns/master/images/images-abstract-factory-pattern/abstract-factory-comic-1-en.png)
> _An IKEA sofa doesn’t match a Victorian-style chairs._
...
![](https://raw.github.com/apal7/java-design-patterns/master/images/images-abstract-factory-pattern/solution1.png)
...
![](https://raw.github.com/apal7/java-design-patterns/master/images/images-abstract-factory-pattern/solution2.png)
...
![](https://raw.github.com/apal7/java-design-patterns/master/images/images-abstract-factory-pattern/abstract-factory-comic-2-en.png)
> _The client shouldn’t care about the concrete class of the factory it works with._


Say the client wants a factory to produce a chair. The client doesn’t have to be aware of the factory’s class, nor does it matter what kind of chair it gets. Whether it’s a modern IKEA model or a Victorian-style chair, the client must treat all chairs in the same manner, using the abstract 'Chair' interface. With this approach, the only thing that the client knows about the chair is that it implements the 'sit' method in some way. Also, whichever variant of the chair is returned, it’ll always match the type of sofa or coffee table produced by the same factory object.
...
### Structure
![](https://raw.github.com/apal7/java-design-patterns/master/images/images-abstract-factory-pattern/structure.png)
...
![](https://raw.github.com/apal7/java-design-patterns/master/images/images-abstract-factory-pattern/example.png)
